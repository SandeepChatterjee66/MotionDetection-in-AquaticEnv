...
def horn_schunk(img1_path, img2_path, frame_pair, alpha=15, delta=40**-1):
    ...
    output_path = f'{frame_pair}_output.png'
...
if __name__ == '__main__':
    print('Horn Schunck program')
    img1 = input('First image name : ')
    img2 = input('Second image name : ')
    
    u, v = horn_schunk(img1, img2, alpha=15, delta=10**-1)
